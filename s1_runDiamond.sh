...
OUT=${DIR1}/${SPECIES1}_${SPECIES2}_diamond_top10.txt

mkdir ${DIR1}

#Run Diamond and save top ten results
diamond blastp -d ${DIAMOND} -q ${INPUT_DIR} --max-target-seqs 10 -b12 -c1 -o ${OUT}
...
then
	...
	OUT=${DIR2}/${SPECIES2}_${SPECIES1}_diamond_top10.txt
